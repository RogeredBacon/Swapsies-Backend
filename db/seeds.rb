...
TradeRequest.create(initiating_user: User.all[Faker::Number.between(from: 1, to: 5)], receiving_user: User.all[Faker::Number.between(from: 1, to: 5)], status: Faker::Lorem.word, initiator_complete: Faker::Boolean.boolean(true_ratio: 0.5), receiver_complete: Faker::Boolean.boolean(true_ratio: 0.5))
TradeRequest.create(initiating_user: User.all[Faker::Number.between(from: 1, to: 5)], receiving_user: User.all[Faker::Number.between(from: 1, to: 5)], status: Faker::Lorem.word, initiator_complete: Faker::Boolean.boolean(true_ratio: 0.5), receiver_complete: Faker::Boolean.boolean(true_ratio: 0.5))
TradeRequest.create(initiating_user: User.all[Faker::Number.between(from: 1, to: 5)], receiving_user: User.all[Faker::Number.between(from: 1, to: 5)], status: Faker::Lorem.word, initiator_complete: Faker::Boolean.boolean(true_ratio: 0.5), receiver_complete: Faker::Boolean.boolean(true_ratio: 0.5))
TradeRequest.create(initiating_user: User.all[Faker::Number.between(from: 1, to: 5)], receiving_user: User.all[Faker::Number.between(from: 1, to: 5)], status: Faker::Lorem.word, initiator_complete: Faker::Boolean.boolean(true_ratio: 0.5), receiver_complete: Faker::Boolean.boolean(true_ratio: 0.5))
TradeRequest.create(initiating_user: User.all[Faker::Number.between(from: 1, to: 5)], receiving_user: User.all[Faker::Number.between(from: 1, to: 5)], status: Faker::Lorem.word, initiator_complete: Faker::Boolean.boolean(true_ratio: 0.5), receiver_complete: Faker::Boolean.boolean(true_ratio: 0.5))
...
10.times do
  TradeRequest.create(initiating_user: User.all[Faker::Number.between(from: 1, to: 5)], receiving_user: User.all[Faker::Number.between(from: 1, to: 5)], status: Faker::Lorem.word, initiator_complete: Faker::Boolean.boolean(true_ratio: 0.2), receiver_complete: Faker::Boolean.boolean(true_ratio: 0.2))
end
